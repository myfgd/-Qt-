...
public:
    ...
    void setupUi(QWidget *ContactItem)
    {
        ...
        verticalSpacer = new QSpacerItem(155, 5, QSizePolicy::Minimum, QSizePolicy::Expanding);
        ...
        verticalSpacer_2 = new QSpacerItem(155, 5, QSizePolicy::Minimum, QSizePolicy::Expanding);

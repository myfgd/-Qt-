...
public:
    ...
    void setupUi(QWidget *SkinWindow)
    {
        ...
        layoutWidget = new QWidget(titleWidget);
        layoutWidget->setObjectName(QStringLiteral("layoutWidget"));
        layoutWidget->setGeometry(QRect(11, -4, 371, 31));
        horizontalLayout = new QHBoxLayout(layoutWidget);
        horizontalLayout->setSpacing(0);
        horizontalLayout->setContentsMargins(11, 11, 11, 11);
        horizontalLayout->setObjectName(QStringLiteral("horizontalLayout"));
        horizontalLayout->setContentsMargins(12, 0, 4, 0);
        titleIcon = new QLabel(layoutWidget);
        ...
        sysmin = new QPushButton(layoutWidget);
        ...
        sysclose = new QPushButton(layoutWidget);
        ...
        gridLayoutWidget = new QWidget(bodyWidget);
        gridLayoutWidget->setObjectName(QStringLiteral("gridLayoutWidget"));
        gridLayoutWidget->setGeometry(QRect(0, 0, 401, 281));
